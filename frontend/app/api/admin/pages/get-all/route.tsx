...
export async function GET (): Promise<NextResponse<ActionGetAllUsers | APIError>> {
  try {
    ...
    const response: Response = await fetchAPI('/api/pages?populate=deep&pagination[pageSize]=100', { token: sessionToken }, false, true)
